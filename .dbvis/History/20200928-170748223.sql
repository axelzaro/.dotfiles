select REPO.VCS_LOCATION_ID
     , REPO.NAME
     , XMLTYPE(REPO.XML_DEFINITION_DATA).EXTRACT('/serverConfiguration/entry/text()').getStringVal() APPLICATION_ID
 ...
 where REPO.PLUGIN_KEY = 'com.atlassian.bamboo.plugins.stash.atlassian-bamboo-plugin-stash:stash-rep';